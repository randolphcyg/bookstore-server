...
# Dump of table tb_bookstore_admin_user
# ------------------------------------------------------------
...
LOCK TABLES `tb_bookstore_admin_user` WRITE;
/*!40000 ALTER TABLE `tb_bookstore_admin_user` DISABLE KEYS */;

INSERT INTO `tb_bookstore_admin_user` (`admin_user_id`, `login_user_name`, `login_password`, `nick_name`, `locked`)
VALUES
...
/*!40000 ALTER TABLE `tb_bookstore_admin_user` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_bookstore_carousel
# ------------------------------------------------------------
...
# Dump of table tb_bookstore_goods_category
# ------------------------------------------------------------
...
LOCK TABLES `tb_bookstore_goods_category` WRITE;
/*!40000 ALTER TABLE `tb_bookstore_goods_category` DISABLE KEYS */;

INSERT INTO `tb_bookstore_goods_category` (`category_id`, `category_level`, `parent_id`, `category_name`, `category_rank`, `is_deleted`, `create_time`, `create_user`, `update_time`, `update_user`)
VALUES
...
/*!40000 ALTER TABLE `tb_bookstore_goods_category` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_bookstore_goods_info
# ------------------------------------------------------------
...
LOCK TABLES `tb_bookstore_goods_info` WRITE;
/*!40000 ALTER TABLE `tb_bookstore_goods_info` DISABLE KEYS */;

INSERT INTO `tb_bookstore_goods_info` (`goods_id`, `goods_name`, `goods_intro`, `goods_category_id`, `goods_cover_img`, `goods_carousel`, `goods_detail_content`, `original_price`, `selling_price`, `stock_num`, `tag`, `goods_sell_status`, `create_user`, `create_time`, `update_user`, `update_time`)
VALUES
...
/*!40000 ALTER TABLE `tb_bookstore_goods_info` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_bookstore_index_config
# ------------------------------------------------------------
...
LOCK TABLES `tb_bookstore_index_config` WRITE;
/*!40000 ALTER TABLE `tb_bookstore_index_config` DISABLE KEYS */;

INSERT INTO `tb_bookstore_index_config` (`config_id`, `config_name`, `config_type`, `goods_id`, `redirect_url`, `config_rank`, `is_deleted`, `create_time`, `create_user`, `update_time`, `update_user`)
VALUES
...
/*!40000 ALTER TABLE `tb_bookstore_index_config` ENABLE KEYS */;
UNLOCK TABLES;

# Dump of table tb_bookstore_order
# ------------------------------------------------------------
...
# Dump of table tb_bookstore_order_address
# ------------------------------------------------------------
...
# Dump of table tb_bookstore_order_item
# ------------------------------------------------------------
...
# Dump of table tb_bookstore_shopping_cart_item
# ------------------------------------------------------------
...
# Dump of table tb_bookstore_user
# ------------------------------------------------------------
...
LOCK TABLES `tb_bookstore_user` WRITE;
/*!40000 ALTER TABLE `tb_bookstore_user` DISABLE KEYS */;

INSERT INTO `tb_bookstore_user` (`user_id`, `nick_name`, `login_name`, `password_md5`, `introduce_sign`, `is_deleted`, `locked_flag`, `create_time`)
VALUES
...
/*!40000 ALTER TABLE `tb_bookstore_user` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_bookstore_user_address
# ------------------------------------------------------------
...
# Dump of table tb_bookstore_user_token
# ------------------------------------------------------------
