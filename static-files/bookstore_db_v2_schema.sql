...
-- ----------------------------
INSERT INTO `tb_bookstore_books_info` VALUES (9, '鸟哥的Linux私房菜', 'Linux经典图书', 21, 'http://localhost:8888/static/3c95c13e568540ee5b74a2236f282edf_20230424140407.jpg', 'http://localhost:8888/static/no-img.png', '<p>本书是最具知名度的Linux入门书《鸟哥的Linux私房菜基础学习篇》的最新版，全面而详细地介绍了Linux操作系统。全书分为5个部分：第一部分着重说明Linux的起源及功能，如何规划和安装Linux主机；第二部分介绍Linux的文件系统、文件、目录与磁盘的管理；第三部分介绍文字模式接口 shell和管理系统的好帮手shell脚本，另外还介绍了文字编辑器vi和vim的使用方法；第四部分介绍了对于系统安全非常重要的Linux账号的管理，以及主机系统与程序的管理，如查看进程、任务分配和作业管理；第五部分介绍了系统管理员(root)的管理事项，如了解系统运行状况、系统服务，针对登录文件进行解析，对系统进行备份以及核心的管理等。</p><p>本书内容丰富全面，基本概念的讲解非常细致，深入浅出。各种功能和命令的介绍，都配以大量的实例操作和详尽的解析。本书是初学者学习Linux不可多得的一本入门好书。</p>', 83, 79, 10, '', 0, 0, '2023-04-24 11:36:08', 0, '2023-04-24 14:04:34');
INSERT INTO `tb_bookstore_books_info` VALUES (666, '走遍中国', '旅游书籍', 20, 'http://localhost:8888/static/a698fbc35bbb9e686aa5820079f42740_20230424140521.jpg', 'http://localhost:8888/static/no-img.png', '<p><a href=\"https://book.douban.com/series/33672\">图说天下：国家地理</a>(共28册)， 这套丛书还有 《全球最美的100魅力古城》《失落的文明》《中国最美的100个地方》《游遍西藏-中国最美的地方精华特辑-图说天下》《全球最美的地方精华特辑.跟着电影去旅行》 等 。<br/></p>', 83, 79, 10, '', 0, 0, '2023-04-24 11:36:08', 0, '2023-04-24 14:05:28');
INSERT INTO `tb_bookstore_books_info` VALUES (777, '平语近人：习近平总书记用典', '作者: 中共中央宣传部 / 中央广播电视总台', 18, 'http://localhost:8888/static/f561aaf6ef0bf14d4208bb46a4ccb3ad_20230424135510.jpg', 'http://localhost:8888/static/no-img.png', '<p>由中共中央宣传部、中央广播电视总台联合创作的《百家讲坛》特别节目《平“语”近人——习近平总书记用典》将于8日至19日在央视综合频道晚间播出。节目从习近平总书记一系列重要讲话、文章、谈话中所引用的古代典籍和经典名句为切入点，旨在推动习近平新时代中国特色社会主义思想的生动阐释与广泛传播。<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;据中央广播电视总台介绍，节目分为《一枝一叶总关情》《治国有常民为本》《国无德不兴》《国之本在家》《报得三春晖》《只留清气满乾坤》《绝知此事要躬行》《腹有诗书气自华》《恶竹应须斩万竿》《天下之治在人才》《咬定青山不放松》《天下为公行大道》12集，由“原声微视频”“思想解读”“经典释义”“现场访谈”“互动问答”“经典诵读”六个环节构成。<br/></p>', 69, 70, 999999, '', 0, 0, '2023-04-24 11:36:08', 0, '2023-04-25 16:03:47');
...
INSERT INTO `tb_bookstore_shopping_cart_item` VALUES (2, 1, 9, 1, 0, '2023-04-26 10:41:35', '2023-04-26 10:41:35');
...
-- ----------------------------
INSERT INTO `tb_bookstore_user_token` VALUES (1, '7a46fb412050ca57ceee87eb2022b967', '2023-04-25 17:25:33', '2023-04-27 17:25:33');
